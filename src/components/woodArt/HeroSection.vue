...
export default {
  data: () => ({
    artBoards: [
      ...
      thumbnail: "/assets/art-board/bw-1.jpg",
      images: [
        "/assets/art-board/bw-1/bw-2.jpg",
        "/assets/art-board/bw-1/bw-3.jpg",
        "/assets/art-board/bw-1/bw-4.jpg",
        "/assets/art-board/bw-1/bw-5.jpg"
    ],
    measuring: {
      size1: "65 cm",
      size2: "75 cm",
    ...
    },
    {
      ...
      thumbnail: "/assets/art-board/by-2.jpg",
      images: [
        "/assets/art-board/by-2/by-1.jpg",
        "/assets/art-board/by-2/by-2.jpg",
        "/assets/art-board/by-2/by-3.jpg"
      ],
      measuring: {
        size1: "4 * 7 cm"
        },
    ...
    },
    {
      ...
      thumbnail: "/assets/art-board/b-3.jpg",
      images: [
        "/assets/art-board/b-3.jpg",
        "/assets/art-board/b-3.jpg",
        "/assets/art-board/b-3.jpg",
        "/assets/art-board/b-3.jpg"
      ],
    ...
    },
    {
      ...
      thumbnail: "/assets/art-board/b-4.jpg",
      images: [
          "/assets/art-board/b-4.jpg",
          "/assets/art-board/b-4.jpg",
          "/assets/art-board/b-4.jpg",
          "/assets/art-board/b-4.jpg"
      ],
    ...
    {
      id: "5",
      thumbnail: "/assets/art-board/bg-5.jpg",

      title: "Galaxy palette..",
      images: [
          "/assets/art-board/bg-5/bg-1.jpg",
        "/assets/art-board/bg-5/bg-2.jpg",
        "/assets/art-board/bg-5/bg-1.jpg",
        "/assets/art-board/bg-5/bg-2.jpg"
      ],
    ...
    },
    {
      ...
      thumbnail: "/assets/art-board/bv-1.jpg",
      images: [
        "/assets/art-board/bv-1.jpg",
        "/assets/art-board/bv-1.jpg",
        "/assets/art-board/bv-1.jpg",
        "/assets/art-board/bv-1.jpg"
      ],
  ...
  methods: {
    loadArtBoards() {
      this.axios.get("/src/assets/db.json")
        .then((response) => {
